...
public class BenhAn implements CoId {
    ...
    public Calendar getNgayKham() { return ngayKham; }
    public void setNgayKham(Calendar ngayKham) { this.ngayKham = ngayKham; }
    ...
    public String toString() {
        ...
        return String.format("%-5s | %-5s | %-5s | %-18s | %-12s | %-12s | %-12s",
                id, patientId, roomId, sdf.format(ngayKham.getTime()), trieuChung, tienSuBenh, chanDoan);
    }
}